...
angular.module('scApp.controllers')
  .controller('LoginCtrl', ['$rootScope', '$scope', '$state', '$stateParams', 'AuthService', 'CustomAlertService',
    function ($rootScope, $scope, $state, $stateParams, AuthService, CustomAlertService) {
