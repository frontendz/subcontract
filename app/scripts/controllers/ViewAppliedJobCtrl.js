(function() {
  ...
  angular.module('scApp.controllers')
    .controller('ViewAppliedJobCtrl', ['$scope', '$state', '$stateParams', 'EmployerServices', 'EmployeeServices', 'AuthService', '$uibModal', 'CustomAlertService', '$timeout',
      function ($scope, $state, $stateParams, EmployerServices, EmployeeServices, AuthService, $uibModal, CustomAlertService, $timeout) {
        var vm = this;
        var userType = '';
        vm.appliedButton = true;
        vm.viewFrom = '';
        var requestParams = {};
